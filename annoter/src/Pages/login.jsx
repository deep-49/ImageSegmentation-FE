...
import { ImagePlus, Mail, Lock, Eye, EyeOff, LogIn, ArrowRight, CheckCircle } from 'lucide-react';
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md mb-8">
        <div className="flex justify-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-2xl text-gray-800">VisionAI</span>
          </div>
        </div>
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            <div>
              ...
              >
                <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                  {isLoading ? (
                    <Spinner className="h-5 w-5 text-blue-300 group-hover:text-blue-400" aria-hidden="true" />
                  ) : (
          ...
          <div className="mt-6 flex items-center justify-center">
            <div className="text-sm">
              ...
              <a href="#" className="font-medium text-blue-600 hover:text-blue-500 inline-flex items-center">
                Sign up
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md mt-8">
        <div className="bg-blue-50 rounded-lg p-4 flex items-start space-x-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-medium text-blue-800">New Feature: Batch Analysis</h3>
            <p className="mt-1 text-sm text-blue-700">
              Now process up to 100 images at once with our upgraded analysis engine.
            </p>
          </div>
        </div>
      </div>
